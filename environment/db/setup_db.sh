#!/bin/bash
  ...
  scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJS_AWS_Deploy_code/app/ ubuntu@ec2-34-249-26-90.eu-west-1.compute.amazonaws.com:/home/ubuntu/

   # syncing provisions folder to vm
  scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJS_AWS_Deploy_code/environment/app/ ubuntu@ec2-34-249-26-90.eu-west-1.compute.amazonaws.com:/home/ubuntu/

  # Syncing db folder to vm
  scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJS_AWS_Deploy_code/environment/db/provision.sh ubuntu@ec2-34-249-26-90.eu-west-1.compute.amazonaws.com:/home/ubuntu/
